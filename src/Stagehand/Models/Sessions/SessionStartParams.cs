...
public record class SessionStartParams : ParamsBase
{
    ...
    /// </summary>
    public ModelClientOptions? ModelClientOptions
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<ModelClientOptions>("modelClientOptions");
        }
        init
        {
            if (value == null)
            ...
            this._rawBodyData.Set("modelClientOptions", value);
        }
    }
...
/// </summary>
[JsonConverter(typeof(ModelClientOptionsConverter))]
public record class ModelClientOptions : ModelBase
{
    public object? Value { get; } = null;
    ...
    public string? ApiKey
    {
        ...
        {
            return Match<string?>(
                bedrockApiKey: (x) => x.ApiKey,
                bedrockAwsCredentials: (_) => null,
                generic: (x) => x.ApiKey
            );
        }
    }
    ...
    public string? BaseUrl
    {
        ...
        {
            return Match<string?>(
                bedrockApiKey: (x) => x.BaseUrl,
                bedrockAwsCredentials: (x) => x.BaseUrl,
                generic: (x) => x.BaseUrl
            );
        }
    }
    ...
    public bool? SkipApiKeyFallback
    {
        ...
        {
            return Match<bool?>(
                bedrockApiKey: (x) => x.SkipApiKeyFallback,
                bedrockAwsCredentials: (x) => x.SkipApiKeyFallback,
                generic: (x) => x.SkipApiKeyFallback
            );
        }
    }

    public ModelClientOptions(BedrockApiKeyModelClientOptions value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public ModelClientOptions(
        BedrockAwsCredentialsModelClientOptions value,
    ...
    public ModelClientOptions(GenericModelClientOptions value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ModelClientOptions(JsonElement element)
    {
        this._element = element;
    }
    ...
    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="BedrockApiKeyModelClientOptions"/>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    ...
    ///     // `value` is of type `BedrockApiKeyModelClientOptions`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    /// </summary>
    public bool TryPickBedrockApiKey([NotNullWhen(true)] out BedrockApiKeyModelClientOptions? value)
    {
        value = this.Value as BedrockApiKeyModelClientOptions;
        return value != null;
    }

    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="BedrockAwsCredentialsModelClientOptions"/>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    ...
    ///     // `value` is of type `BedrockAwsCredentialsModelClientOptions`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    ...
    public bool TryPickBedrockAwsCredentials(
        [NotNullWhen(true)] out BedrockAwsCredentialsModelClientOptions? value
    )
    {
        value = this.Value as BedrockAwsCredentialsModelClientOptions;
        return value != null;
    }

    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="GenericModelClientOptions"/>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    /// <code>
    /// if (instance.TryPickGeneric(out var value)) {
    ///     // `value` is of type `GenericModelClientOptions`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    /// </summary>
    public bool TryPickGeneric([NotNullWhen(true)] out GenericModelClientOptions? value)
    {
        value = this.Value as GenericModelClientOptions;
        return value != null;
    }
    ...
    /// <code>
    /// instance.Switch(
    ///     (BedrockApiKeyModelClientOptions value) =&gt; {...},
    ///     (BedrockAwsCredentialsModelClientOptions value) =&gt; {...},
    ///     (GenericModelClientOptions value) =&gt; {...}
    /// );
    /// </code>
    /// </example>
    /// </summary>
    public void Switch(
        System::Action<BedrockApiKeyModelClientOptions> bedrockApiKey,
        System::Action<BedrockAwsCredentialsModelClientOptions> bedrockAwsCredentials,
        System::Action<GenericModelClientOptions> generic
    )
    {
        switch (this.Value)
        {
            case BedrockApiKeyModelClientOptions value:
                bedrockApiKey(value);
                break;
            case BedrockAwsCredentialsModelClientOptions value:
                bedrockAwsCredentials(value);
                break;
            case GenericModelClientOptions value:
                generic(value);
                break;
            default:
                throw new StagehandInvalidDataException(
                    "Data did not match any variant of ModelClientOptions"
                );
        }
    }
    ...
    /// </summary>
    public T Match<T>(
        System::Func<BedrockApiKeyModelClientOptions, T> bedrockApiKey,
        System::Func<BedrockAwsCredentialsModelClientOptions, T> bedrockAwsCredentials,
        System::Func<GenericModelClientOptions, T> generic
    )
    {
        return this.Value switch
        {
            BedrockApiKeyModelClientOptions value => bedrockApiKey(value),
            BedrockAwsCredentialsModelClientOptions value => bedrockAwsCredentials(value),
            GenericModelClientOptions value => generic(value),
            _ => throw new StagehandInvalidDataException(
                "Data did not match any variant of ModelClientOptions"
            ),
        };
    ...
    public static implicit operator ModelClientOptions(BedrockApiKeyModelClientOptions value) =>
        new(value);

    public static implicit operator ModelClientOptions(
        BedrockAwsCredentialsModelClientOptions value
    ) => new(value);

    public static implicit operator ModelClientOptions(GenericModelClientOptions value) =>
        new(value);
    ...
    public override void Validate()
    {
        ...
        this.Switch(
            ...
            (generic) => generic.Validate()
        );
    }

    public virtual bool Equals(ModelClientOptions? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
    ...
    int VariantIndex()
    {
        return this.Value switch
        {
            BedrockApiKeyModelClientOptions _ => 0,
            BedrockAwsCredentialsModelClientOptions _ => 1,
            GenericModelClientOptions _ => 2,
            _ => -1,
        };
    }
}

sealed class ModelClientOptionsConverter : JsonConverter<ModelClientOptions>
{
    public override ModelClientOptions? Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        ...
        try
        {
            var deserialized = JsonSerializer.Deserialize<BedrockApiKeyModelClientOptions>(
                element,
                options
            );
            if (deserialized != null)
        ...
        try
        {
            var deserialized = JsonSerializer.Deserialize<BedrockAwsCredentialsModelClientOptions>(
                element,
                options
            );
            if (deserialized != null)
        ...
        try
        {
            var deserialized = JsonSerializer.Deserialize<GenericModelClientOptions>(
                element,
                options
            );
            if (deserialized != null)
...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BedrockApiKeyModelClientOptionsFromRaw
    >)
)]
public sealed record class BedrockApiKeyModelClientOptions : JsonModel
{
    /// <summary>
    ...
    public BedrockApiKeyModelClientOptions() { }
...
#pragma warning disable CS8618
    ...
    public BedrockApiKeyModelClientOptions(
        ...
        : base(bedrockApiKeyModelClientOptions) { }
#pragma warning restore CS8618

    public BedrockApiKeyModelClientOptions(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BedrockApiKeyModelClientOptions(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BedrockApiKeyModelClientOptionsFromRaw.FromRawUnchecked"/>
    public static BedrockApiKeyModelClientOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class BedrockApiKeyModelClientOptionsFromRaw : IFromRawJson<BedrockApiKeyModelClientOptions>
{
    /// <inheritdoc/>
    public BedrockApiKeyModelClientOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BedrockApiKeyModelClientOptions.FromRawUnchecked(rawData);
}
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public ProviderOptions(string region)
        : this()
    {
        this.Region = region;
    }
...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        BedrockAwsCredentialsModelClientOptionsFromRaw
    >)
)]
public sealed record class BedrockAwsCredentialsModelClientOptions : JsonModel
{
    public required BedrockAwsCredentialsModelClientOptionsProviderOptions ProviderOptions
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<BedrockAwsCredentialsModelClientOptionsProviderOptions>(
                "providerOptions"
            );
        }
        init { this._rawData.Set("providerOptions", value); }
    ...
    public BedrockAwsCredentialsModelClientOptions() { }
...
#pragma warning disable CS8618
    ...
    public BedrockAwsCredentialsModelClientOptions(
        ...
        : base(bedrockAwsCredentialsModelClientOptions) { }
#pragma warning restore CS8618

    public BedrockAwsCredentialsModelClientOptions(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BedrockAwsCredentialsModelClientOptions(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BedrockAwsCredentialsModelClientOptionsFromRaw.FromRawUnchecked"/>
    public static BedrockAwsCredentialsModelClientOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    ...
    [SetsRequiredMembers]
    public BedrockAwsCredentialsModelClientOptions(
        BedrockAwsCredentialsModelClientOptionsProviderOptions providerOptions
    )
        : this()
    {
...
class BedrockAwsCredentialsModelClientOptionsFromRaw
    : IFromRawJson<BedrockAwsCredentialsModelClientOptions>
{
    /// <inheritdoc/>
    public BedrockAwsCredentialsModelClientOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BedrockAwsCredentialsModelClientOptions.FromRawUnchecked(rawData);
}

[JsonConverter(
    typeof(JsonModelConverter<
        BedrockAwsCredentialsModelClientOptionsProviderOptions,
        BedrockAwsCredentialsModelClientOptionsProviderOptionsFromRaw
    >)
)]
public sealed record class BedrockAwsCredentialsModelClientOptionsProviderOptions : JsonModel
{
    /// <summary>
    ...
    public BedrockAwsCredentialsModelClientOptionsProviderOptions() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BedrockAwsCredentialsModelClientOptionsProviderOptions(
        BedrockAwsCredentialsModelClientOptionsProviderOptions bedrockAwsCredentialsModelClientOptionsProviderOptions
    )
        : base(bedrockAwsCredentialsModelClientOptionsProviderOptions) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="BedrockAwsCredentialsModelClientOptionsProviderOptionsFromRaw.FromRawUnchecked"/>
    public static BedrockAwsCredentialsModelClientOptionsProviderOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class BedrockAwsCredentialsModelClientOptionsProviderOptionsFromRaw
    : IFromRawJson<BedrockAwsCredentialsModelClientOptionsProviderOptions>
{
    /// <inheritdoc/>
    public BedrockAwsCredentialsModelClientOptionsProviderOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BedrockAwsCredentialsModelClientOptionsProviderOptions.FromRawUnchecked(rawData);
}

[JsonConverter(
    typeof(JsonModelConverter<GenericModelClientOptions, GenericModelClientOptionsFromRaw>)
)]
public sealed record class GenericModelClientOptions : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public GenericModelClientOptionsProviderOptions? ProviderOptions
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<GenericModelClientOptionsProviderOptions>(
                "providerOptions"
            );
        }
        init
    ...
    public GenericModelClientOptions() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public GenericModelClientOptions(GenericModelClientOptions genericModelClientOptions)
        : base(genericModelClientOptions) { }
#pragma warning restore CS8618

    public GenericModelClientOptions(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    GenericModelClientOptions(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="GenericModelClientOptionsFromRaw.FromRawUnchecked"/>
    public static GenericModelClientOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class GenericModelClientOptionsFromRaw : IFromRawJson<GenericModelClientOptions>
{
    /// <inheritdoc/>
    public GenericModelClientOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => GenericModelClientOptions.FromRawUnchecked(rawData);
}
...
/// { project, location, googleAuthOptions }.
/// </summary>
[JsonConverter(typeof(GenericModelClientOptionsProviderOptionsConverter))]
public record class GenericModelClientOptionsProviderOptions : ModelBase
{
    public object? Value { get; } = null;
    ...
    public GenericModelClientOptionsProviderOptions(
        BedrockApiKeyProviderOptions value,
        JsonElement? element = null
    )
    {
        this.Value = value;
    ...
    public GenericModelClientOptionsProviderOptions(
        BedrockAwsCredentialsProviderOptions value,
        JsonElement? element = null
    )
    {
        this.Value = value;
    ...
    public GenericModelClientOptionsProviderOptions(
        GoogleVertexProviderOptions value,
        JsonElement? element = null
    )
    {
        this.Value = value;
    ...
    public GenericModelClientOptionsProviderOptions(JsonElement element)
    {
        this._element = element;
    }
    ...
    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="BedrockApiKeyProviderOptions"/>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    /// <code>
    /// if (instance.TryPickBedrockApiKey(out var value)) {
    ///     // `value` is of type `BedrockApiKeyProviderOptions`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    /// </summary>
    public bool TryPickBedrockApiKey([NotNullWhen(true)] out BedrockApiKeyProviderOptions? value)
    {
        value = this.Value as BedrockApiKeyProviderOptions;
        return value != null;
    }

    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="BedrockAwsCredentialsProviderOptions"/>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    /// <code>
    /// if (instance.TryPickBedrockAwsCredentials(out var value)) {
    ///     // `value` is of type `BedrockAwsCredentialsProviderOptions`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    /// </summary>
    public bool TryPickBedrockAwsCredentials(
        [NotNullWhen(true)] out BedrockAwsCredentialsProviderOptions? value
    )
    {
        value = this.Value as BedrockAwsCredentialsProviderOptions;
        return value != null;
    }

    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="GoogleVertexProviderOptions"/>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    ...
    ///     // `value` is of type `GoogleVertexProviderOptions`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    /// </summary>
    public bool TryPickGoogleVertex([NotNullWhen(true)] out GoogleVertexProviderOptions? value)
    {
        value = this.Value as GoogleVertexProviderOptions;
        return value != null;
    }
    ...
    /// </summary>
    public void Switch(
        System::Action<BedrockApiKeyProviderOptions> bedrockApiKey,
        System::Action<BedrockAwsCredentialsProviderOptions> bedrockAwsCredentials,
        System::Action<GoogleVertexProviderOptions> googleVertex
    )
    {
        switch (this.Value)
        {
            case BedrockApiKeyProviderOptions value:
                bedrockApiKey(value);
                break;
            case BedrockAwsCredentialsProviderOptions value:
                bedrockAwsCredentials(value);
                break;
            case GoogleVertexProviderOptions value:
                googleVertex(value);
                break;
            default:
                throw new StagehandInvalidDataException(
                    "Data did not match any variant of GenericModelClientOptionsProviderOptions"
                );
        }
    }
    ...
    /// </summary>
    public T Match<T>(
        System::Func<BedrockApiKeyProviderOptions, T> bedrockApiKey,
        System::Func<BedrockAwsCredentialsProviderOptions, T> bedrockAwsCredentials,
        System::Func<GoogleVertexProviderOptions, T> googleVertex
    )
    {
        return this.Value switch
        {
            BedrockApiKeyProviderOptions value => bedrockApiKey(value),
            BedrockAwsCredentialsProviderOptions value => bedrockAwsCredentials(value),
            GoogleVertexProviderOptions value => googleVertex(value),
            _ => throw new StagehandInvalidDataException(
                "Data did not match any variant of GenericModelClientOptionsProviderOptions"
            ),
        };
    ...
    public static implicit operator GenericModelClientOptionsProviderOptions(
        BedrockApiKeyProviderOptions value
    ) => new(value);
    ...
    public virtual bool Equals(GenericModelClientOptionsProviderOptions? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
    ...
    int VariantIndex()
    {
        return this.Value switch
        {
            BedrockApiKeyProviderOptions _ => 0,
            BedrockAwsCredentialsProviderOptions _ => 1,
            GoogleVertexProviderOptions _ => 2,
            _ => -1,
        };
    }
}

sealed class GenericModelClientOptionsProviderOptionsConverter
    : JsonConverter<GenericModelClientOptionsProviderOptions>
{
    public override GenericModelClientOptionsProviderOptions? Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        ...
        try
        {
            var deserialized = JsonSerializer.Deserialize<BedrockApiKeyProviderOptions>(
                element,
                options
            );
            if (deserialized != null)
        ...
        try
        {
            var deserialized = JsonSerializer.Deserialize<BedrockAwsCredentialsProviderOptions>(
                element,
                options
            );
            if (deserialized != null)
        ...
        try
        {
            var deserialized = JsonSerializer.Deserialize<GoogleVertexProviderOptions>(
                element,
                options
            );
            if (deserialized != null)
    ...
    public override void Write(
        Utf8JsonWriter writer,
        GenericModelClientOptionsProviderOptions value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value.Json, options);
...
[JsonConverter(
    typeof(JsonModelConverter<BedrockApiKeyProviderOptions, BedrockApiKeyProviderOptionsFromRaw>)
)]
public sealed record class BedrockApiKeyProviderOptions : JsonModel
{
    /// <summary>
    /// AWS region for Amazon Bedrock
    /// </summary>
    ...
    public BedrockApiKeyProviderOptions() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BedrockApiKeyProviderOptions(BedrockApiKeyProviderOptions bedrockApiKeyProviderOptions)
        : base(bedrockApiKeyProviderOptions) { }
#pragma warning restore CS8618

    public BedrockApiKeyProviderOptions(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BedrockApiKeyProviderOptions(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BedrockApiKeyProviderOptionsFromRaw.FromRawUnchecked"/>
    public static BedrockApiKeyProviderOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    ...
    [SetsRequiredMembers]
    public BedrockApiKeyProviderOptions(string region)
        : this()
    {
        this.Region = region;
    }
...
class BedrockApiKeyProviderOptionsFromRaw : IFromRawJson<BedrockApiKeyProviderOptions>
{
    /// <inheritdoc/>
    public BedrockApiKeyProviderOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BedrockApiKeyProviderOptions.FromRawUnchecked(rawData);
}

[JsonConverter(
    typeof(JsonModelConverter<
        BedrockAwsCredentialsProviderOptions,
        BedrockAwsCredentialsProviderOptionsFromRaw
    >)
)]
public sealed record class BedrockAwsCredentialsProviderOptions : JsonModel
{
    /// <summary>
    /// AWS access key ID for Bedrock
    /// </summary>
    ...
    public BedrockAwsCredentialsProviderOptions() { }
...
#pragma warning disable CS8618
    ...
    public BedrockAwsCredentialsProviderOptions(
        ...
        : base(bedrockAwsCredentialsProviderOptions) { }
#pragma warning restore CS8618

    public BedrockAwsCredentialsProviderOptions(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BedrockAwsCredentialsProviderOptions(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BedrockAwsCredentialsProviderOptionsFromRaw.FromRawUnchecked"/>
    public static BedrockAwsCredentialsProviderOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class BedrockAwsCredentialsProviderOptionsFromRaw
    : IFromRawJson<BedrockAwsCredentialsProviderOptions>
{
    /// <inheritdoc/>
    public BedrockAwsCredentialsProviderOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BedrockAwsCredentialsProviderOptions.FromRawUnchecked(rawData);
}

[JsonConverter(
    typeof(JsonModelConverter<GoogleVertexProviderOptions, GoogleVertexProviderOptionsFromRaw>)
)]
public sealed record class GoogleVertexProviderOptions : JsonModel
{
    /// <summary>
    ...
    public GoogleVertexProviderOptions() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public GoogleVertexProviderOptions(GoogleVertexProviderOptions googleVertexProviderOptions)
        : base(googleVertexProviderOptions) { }
#pragma warning restore CS8618

    public GoogleVertexProviderOptions(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    GoogleVertexProviderOptions(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="GoogleVertexProviderOptionsFromRaw.FromRawUnchecked"/>
    public static GoogleVertexProviderOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class GoogleVertexProviderOptionsFromRaw : IFromRawJson<GoogleVertexProviderOptions>
{
    /// <inheritdoc/>
    public GoogleVertexProviderOptions FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => GoogleVertexProviderOptions.FromRawUnchecked(rawData);
}
