...
public sealed record class Browser : JsonModel
{
    ...
    /// Browser type to use
    /// </summary>
    public ApiEnum<string, global::StagehandSdk.Models.Sessions.Type>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, global::StagehandSdk.Models.Sessions.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::StagehandSdk.Models.Sessions.Type>
{
    public override global::StagehandSdk.Models.Sessions.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        ...
        {
            "local" => global::StagehandSdk.Models.Sessions.Type.Local,
            "browserbase" => global::StagehandSdk.Models.Sessions.Type.Browserbase,
            _ => (global::StagehandSdk.Models.Sessions.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::StagehandSdk.Models.Sessions.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::StagehandSdk.Models.Sessions.Type.Local => "local",
                global::StagehandSdk.Models.Sessions.Type.Browserbase => "browserbase",
                _ => throw new StagehandInvalidDataException(
