...
public class SessionActParamsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var parameters = new Sessions::SessionActParams
        {
            ...
            Options = new()
            {
                Model = new Sessions::VertexModelConfigObject()
                {
                    Auth = new()
                    {
                        Credentials = new()
                        {
                            ...
                            Type = Sessions::Type.ServiceAccount,
...
public class OptionsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        Sessions::Model expectedModel = new Sessions::VertexModelConfigObject()
        {
            Auth = new()
            {
                Credentials = new()
...
public class ModelTest : TestBase
{
    ...
    {
        Sessions::Model value = new Sessions::VertexModelConfigObject()
        {
            Auth = new()
            {
                Credentials = new()
    ...
    {
        Sessions::Model value = new Sessions::AzureEntraModelConfigObject()
        {
            Auth = new("x"),
            ModelName = "openai/gpt-5.4-mini",
            ProviderOptions = new(
    ...
    {
        Sessions::Model value = new Sessions::AzureApiKeyModelConfigObject()
        {
            ModelName = "openai/gpt-5.4-mini",
            ProviderOptions = new(
                new Sessions::AzureApiKeyModelConfigObjectProviderOptionsAzure()
                {
                    ApiVersion = "2024-10-01-preview",
                    BaseUrl = "https://example.com",
                    Headers = new Dictionary<string, string>() { { "foo", "string" } },
    ...
    {
        Sessions::Model value = new Sessions::GenericModelConfigObject()
        {
            ModelName = "openai/gpt-5.4-mini",
            ApiKey = "sk-some-openai-api-key",
            BaseUrl = "https://api.openai.com/v1",
            Headers = new Dictionary<string, string>() { { "foo", "string" } },
            OpenAIEndpointFormat = Sessions::OpenAIEndpointFormat.Chat,
            Provider = Sessions::Provider.OpenAI,
        };
        value.Validate();
    }
...
public class VertexModelConfigObjectTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::VertexModelConfigObject
        {
            Auth = new()
            {
                Credentials = new()
        ...
        Sessions::Auth expectedAuth = new()
        {
            Credentials = new()
            {
                ClientEmail = "client_email",
        ...
        Sessions::ProviderOptions expectedProviderOptions = new(
            new Sessions::Vertex()
            {
                Location = "us-central1",
                Project = "my-gcp-project",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::VertexModelConfigObject>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::VertexModelConfigObject copied = new(model);
...
public class AuthTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        Sessions::Credentials expectedCredentials = new()
        {
            ClientEmail = "client_email",
            PrivateKey = "private_key",
            AuthProviderX509CertUrl = "https://example.com",
        ...
        Sessions::Scopes expectedScopes = "string";
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::Auth>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::Auth copied = new(model);
...
public class CredentialsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::Credentials
        {
            ClientEmail = "client_email",
            PrivateKey = "private_key",
            AuthProviderX509CertUrl = "https://example.com",
        ...
        ApiEnum<string, Sessions::Type> expectedType = Sessions::Type.ServiceAccount;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::Credentials>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::Credentials copied = new(model);
...
{
    [Theory]
    [InlineData(Sessions::Type.ServiceAccount)]
...
public class ScopesTest : TestBase
{
    ...
    {
        Sessions::Scopes value = new(["string"]);
        value.Validate();
    }
    ...
    public void StringSerializationRoundtripWorks()
    {
        Sessions::Scopes value = "string";
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::Scopes>(
            element,
            ModelBase.SerializerOptions
        );
...
public class ProviderOptionsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::ProviderOptions
        {
            Vertex = new()
            {
                Location = "us-central1",
        ...
        Sessions::Vertex expectedVertex = new()
        {
            Location = "us-central1",
            Project = "my-gcp-project",
            BaseUrl = "https://example.com",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::ProviderOptions>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::ProviderOptions copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class VertexTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::Vertex
        {
            Location = "us-central1",
            Project = "my-gcp-project",
            BaseUrl = "https://example.com",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::Vertex>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new Sessions::Vertex { Location = "us-central1", Project = "my-gcp-project" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::Vertex copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class AzureEntraModelConfigObjectTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::AzureEntraModelConfigObject
        {
            Auth = new("x"),
            ModelName = "openai/gpt-5.4-mini",
            ProviderOptions = new(
        ...
        Sessions::AzureEntraModelConfigObjectAuth expectedAuth = new("x");
        string expectedModelName = "openai/gpt-5.4-mini";
        JsonElement expectedProvider = JsonSerializer.SerializeToElement("azure");
        Sessions::AzureEntraModelConfigObjectProviderOptions expectedProviderOptions = new(
            new Sessions::Azure()
            {
                ApiVersion = "2024-10-01-preview",
                BaseUrl = "https://example.com",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::AzureEntraModelConfigObject>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::AzureEntraModelConfigObject copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class AzureEntraModelConfigObjectAuthTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::AzureEntraModelConfigObjectAuth { Token = "x" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::AzureEntraModelConfigObjectAuth>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::AzureEntraModelConfigObjectAuth copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class AzureEntraModelConfigObjectProviderOptionsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::AzureEntraModelConfigObjectProviderOptions
        {
            Azure = new()
            {
                ApiVersion = "2024-10-01-preview",
        ...
        Sessions::Azure expectedAzure = new()
        {
            ApiVersion = "2024-10-01-preview",
            BaseUrl = "https://example.com",
            Headers = new Dictionary<string, string>() { { "foo", "string" } },
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Sessions::AzureEntraModelConfigObjectProviderOptions>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::AzureEntraModelConfigObjectProviderOptions copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class AzureTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::Azure
        {
            ApiVersion = "2024-10-01-preview",
            BaseUrl = "https://example.com",
            Headers = new Dictionary<string, string>() { { "foo", "string" } },
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::Azure>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::Azure copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class AzureApiKeyModelConfigObjectTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::AzureApiKeyModelConfigObject
        {
            ModelName = "openai/gpt-5.4-mini",
            ProviderOptions = new(
                new Sessions::AzureApiKeyModelConfigObjectProviderOptionsAzure()
        ...
        string expectedModelName = "openai/gpt-5.4-mini";
        JsonElement expectedProvider = JsonSerializer.SerializeToElement("azure");
        Sessions::AzureApiKeyModelConfigObjectProviderOptions expectedProviderOptions = new(
            new Sessions::AzureApiKeyModelConfigObjectProviderOptionsAzure()
            {
                ApiVersion = "2024-10-01-preview",
                BaseUrl = "https://example.com",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::AzureApiKeyModelConfigObject>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::AzureApiKeyModelConfigObject copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class AzureApiKeyModelConfigObjectProviderOptionsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::AzureApiKeyModelConfigObjectProviderOptions
        {
            Azure = new()
            {
                ApiVersion = "2024-10-01-preview",
        ...
        Sessions::AzureApiKeyModelConfigObjectProviderOptionsAzure expectedAzure = new()
        {
            ApiVersion = "2024-10-01-preview",
            BaseUrl = "https://example.com",
            Headers = new Dictionary<string, string>() { { "foo", "string" } },
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Sessions::AzureApiKeyModelConfigObjectProviderOptions>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::AzureApiKeyModelConfigObjectProviderOptions copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class AzureApiKeyModelConfigObjectProviderOptionsAzureTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::AzureApiKeyModelConfigObjectProviderOptionsAzure
        {
            ApiVersion = "2024-10-01-preview",
            BaseUrl = "https://example.com",
            Headers = new Dictionary<string, string>() { { "foo", "string" } },
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Sessions::AzureApiKeyModelConfigObjectProviderOptionsAzure>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::AzureApiKeyModelConfigObjectProviderOptionsAzure copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class GenericModelConfigObjectTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Sessions::GenericModelConfigObject
        {
            ModelName = "openai/gpt-5.4-mini",
            ApiKey = "sk-some-openai-api-key",
            BaseUrl = "https://api.openai.com/v1",
        ...
        string expectedBaseUrl = "https://api.openai.com/v1";
        Dictionary<string, string> expectedHeaders = new() { { "foo", "string" } };
        ApiEnum<string, Sessions::OpenAIEndpointFormat> expectedOpenAIEndpointFormat =
            Sessions::OpenAIEndpointFormat.Chat;
        ApiEnum<string, Sessions::Provider> expectedProvider = Sessions::Provider.OpenAI;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Sessions::GenericModelConfigObject>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new Sessions::GenericModelConfigObject { ModelName = "openai/gpt-5.4-mini" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        Sessions::GenericModelConfigObject copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class OpenAIEndpointFormatTest : TestBase
{
    [Theory]
    [InlineData(Sessions::OpenAIEndpointFormat.Responses)]
    [InlineData(Sessions::OpenAIEndpointFormat.Chat)]
    public void Validation_Works(Sessions::OpenAIEndpointFormat rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Sessions::OpenAIEndpointFormat> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Sessions::OpenAIEndpointFormat>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Sessions::OpenAIEndpointFormat.Responses)]
    [InlineData(Sessions::OpenAIEndpointFormat.Chat)]
    public void SerializationRoundtrip_Works(Sessions::OpenAIEndpointFormat rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Sessions::OpenAIEndpointFormat> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, Sessions::OpenAIEndpointFormat>
...
{
    [Theory]
    [InlineData(Sessions::Provider.OpenAI)]
    [InlineData(Sessions::Provider.Anthropic)]
    [InlineData(Sessions::Provider.Google)]
    [InlineData(Sessions::Provider.Microsoft)]
    [InlineData(Sessions::Provider.Bedrock)]
    public void Validation_Works(Sessions::Provider rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Sessions::Provider> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, Sessions::Provider>>(
            JsonSerializer.SerializeToElement("invalid value"),
            ModelBase.SerializerOptions
        );
    ...
    [InlineData(Sessions::Provider.Microsoft)]
    [InlineData(Sessions::Provider.Bedrock)]
    public void SerializationRoundtrip_Works(Sessions::Provider rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, Sessions::Provider> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, Sessions::Provider>>(
            json,
            ModelBase.SerializerOptions
        );
